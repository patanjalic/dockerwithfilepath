...
The file contents given in the path in application.properties are printed
to console output
Volume is mounted on docker and file is added to the path

Build docker image with

----
docker build -t dockerimagewithpath .
----

run the image with

----
docker run -p 8080:8080 dockerimagewithpath
----
